...
class Gene2Refseq(SQLModel, table=True):
    ...
    status: str | None = Field(
        default=None,
        sa_column=Column("g2r_status", String))
    g2r_rna_nt_acc_ver: str | None = Field(default=None, primary_key=True)
    rna_nt_gi: str | None = Field(
        default=None,
        sa_column=Column("g2r_rna_nt_gi", String))
    prot_acc_ver: str | None = Field(
        default=None,
        sa_column=Column("g2r_prot_acc_ver", String))
    prot_gi: str | None = Field(
        default=None,
        sa_column=Column("g2r_prot_gi", String))
    gen_nt_acc_ver: str | None = Field(
        default=None,
        sa_column=Column("g2r_gen_nt_acc_ver", String))
    gen_nt_gi: str | None = Field(
        default=None,
        sa_column=Column("g2r_gen_nt_gi", String))
    start_pos_gen_acc: str | None = Field(
        default=None,
        sa_column=Column("g2r_start_pos_gen_acc", String))
    end_pos_gen_acc: str | None = Field(
        default=None,
        sa_column=Column("g2r_end_pos_gen_acc", String))
    orientation: str | None = Field(
        default=None,
        sa_column=Column("g2r_orientation", String))
    assembly: str | None = Field(
        default=None,
        sa_column=Column("g2r_assembly", String))
    mat_pept_acc_ver: str | None = Field(
        default=None,
        sa_column=Column("g2r_mat_pept_acc_ver", String))
    mat_pept_gi: str | None = Field(
        default=None,
        sa_column=Column("g2r_mat_pept_gi", String))
    symbol: str | None = Field(
        default=None,
        sa_column=Column("g2r_symbol", String))
